...
<body>
  ...
  <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="<?php echo url('admin/dashboard') ?>">Admin</a>
      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-body-tertiary sidebar collapse">
        <div class="position-sticky pt-3 sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="<?php echo url('admin/dashboard') ?>">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="<?php echo url('admin/profile') ?>">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="<?php echo url('guru') ?>">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="<?php echo url('siswa') ?>">
                <span data-feather="users" class="align-text-bottom"></span>
                Siswa
              </a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="<?php echo url('kelas') ?>">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="<?php echo url('mapel') ?>">
                <span data-feather="star" class="align-text-bottom"></span>
                Mapel
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="<?php echo url('jurusan') ?>">
                <span data-feather="tag" class="align-text-bottom"></span>
                Jurusan
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="<?php echo url('tahun_ajaran') ?>">
