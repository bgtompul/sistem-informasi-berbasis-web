...
<body>
  ...
  <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 " href="#">Guru</a>
      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-body-tertiary sidebar collapse">
        <div class="position-sticky pt-3 sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="<?php echo url('guru/dashboard') ?>">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="<?php echo url('guru/profile') ?>">
            ...
            <li class="nav-item">
              <a class="nav-link px-3" href="<?php echo url('/') ?>"><span data-feather="log-out" class="align-text-bottom"></span> Logout</a>	
            </li>
          </ul>
